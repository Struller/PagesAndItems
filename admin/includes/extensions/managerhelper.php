	...
	protected static function _load($sort = null)
	{
		...
		if (!$managers = $db->loadObjectList())
		{
			if($db->getErrorMsg() != '')
			{
				...
				JError::raiseWarning('SOME_ERROR_CODE', 'Error loading Extensions: type: manager, dberror: '. $db->getErrorMsg());
			}
			else
			{
				...
				*/
				//JError::raiseWarning('SOME_ERROR_CODE', 'Error loading Extensions: type: manager,  Extension seem not installed');
			}
			return false;
		}
		return $managers;
