 ...
 */
class JFormFieldRadiolong extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		$classfieldset = $this->element['class'] ? ' class="radio '.(string) $this->element['class'].'"' : ' class="radio"';

		// Start the radio field output.
		$html[] = '<fieldset id="'.$this->id.'"'.$classfieldset.'>';
		...
		foreach ($options as $i => $option) {
			...
			$html[] = '<fieldset id="'.$this->id.$i.'"'.$classfieldset.'>';
