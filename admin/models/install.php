...
class PagesAndItemsModelInstall extends InstallerModelInstall //JModel
{
	...
	function install()
	{
		...
		require_once( dirname(__FILE__).DS.'..'.DS.'includes'.DS.'installer'.DS.'installerhelper.php' );
		require_once( dirname(__FILE__).DS.'..'.DS.'includes'.DS.'installer'.DS.'installer.php');
