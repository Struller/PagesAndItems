...
class PagesAndItemsModelFormextension extends JModelAdmin
{
	...
	*/
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_pagesanditems.formextension', 'formextension', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_pagesanditems.edit.formextension.data', array());
	...
	public function getItem($pk = null)
	{
		...
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('formextension.extension_id');
		//echo '$pk: '.$pk.' :$pk,';
		//echo '$pk state : '.$this->getState('formextension.extension_id').' :$pk state,';
		//echo 'X';
		//$this->_cache[$pk]
		if (!isset($this->_cache[$pk])) 
		{
			...
			//$this->setState('formextension.extension_id',$pk);
		}
