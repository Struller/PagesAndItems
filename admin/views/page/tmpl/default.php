...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	<tr>
		...
		<?php
			...
			//echo 'acl='.$this->helper->check_pi_acl('1');
		...
		<td valign="top">
				...
				?>
					{
						...
						if (pressbutton == 'page_move_select')
						{
							...
							//return;
							document.location.href = 'index.php?option=com_pagesanditems&view=page_move_select&pageId='+<?php echo $this->pageId; ?>;
							return;
						}
					...
					function new_item(page_id){						
						...
						itemtype = document.getElementById('select_itemtype').value;						
						document.location.href = 'index.php?option=com_pagesanditems&view=item&sub_task=new&pageType='+pageType+'&pageId='+page_id+'&item_type='+itemtype;
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
				<tr>
					...
					<td valign="top" width="49%" id="itemsPage">
			...
			$all_fields = $this->helper->get_all_page_fields();
