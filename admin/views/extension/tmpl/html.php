...
$showFooter = JRequest::getVar('showFooter', 0 );
...
ExtensionHtmlHelper::importExtension($extensionFolder, $extensionName,true,null,true);
...
if($popup)
{
	...
	*/
	...
	$htmlHeaderTitle = JText::_( 'Pages and Items');
	$htmlHeaderImage = PagesAndItemsHelper::getDirIcons().'icon-32-pi.png';
	$results = $dispatcher->trigger('onHtmlDisplay_HeaderImage', array(&$htmlHeaderImage,$extensionName)); //,$this->model));
	...
	$results = $dispatcher->trigger('onHtmlDisplay_HeaderTitle', array(&$htmlHeaderTitle,$extensionName)); //,$this->model));
	if($htmlHeaderTitle != '')
	{
		//$title = ...
	}
...
<?php echo PagesAndItemsHelper::getHeaderImageTitle($htmlHeaderImage,$htmlHeaderTitle); ?>
		<?php
		/*
<div class="formHeader">

	<h1 class="pi_h1">
		<img src="<?php echo $htmlHeaderImage; ?>" alt="..." class="pi_icon" />
		<?php echo '&nbsp;'.$htmlHeaderTitle; ?>
	</h1>
</div>
*/
?>
...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	...
	?>
		<td valign="top" > <!-- style="  font-size: 100% !important;font-family: monospace;"> -->
			...
			$htmlContent = & new JObject();
			$htmlContent->text = '';
			$results = $dispatcher->trigger('onHtmlDisplay_subtask', array(&$htmlContent,$extensionName,$sub_task)); //,$this->model));
			echo $htmlContent->text;
