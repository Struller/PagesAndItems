...
ExtensionHtmlHelper::importExtension($extensionFolder, $extension,true,null,true);
...
if($popup)
{
	...
	*/
	...
	$results = $dispatcher->trigger('onHtmlDisplay_HeaderImage', array(&$htmlHeaderImage,$extension,$this->model));
	...
	$results = $dispatcher->trigger('onHtmlDisplay_HeaderTitle', array(&$htmlHeaderTitle,$extension,$this->model));
	if($htmlHeaderTitle != '')
	{
		//$title = ...
	}
...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	...
	?>
		<td valign="top" > <!-- style="  font-size: 100% !important;font-family: monospace;"> -->
			...
			$htmlContent->text = '';
			$results = $dispatcher->trigger('onHtmlDisplay_subtask', array(&$htmlContent,$extension,$sub_task,$this->model));
...
<?php
	...
	*/
	...
	$results = $dispatcher->trigger('onHtmlDisplay_Button', array(&$htmlButton,$extension,$this->model));
	echo $htmlButton;
?>
