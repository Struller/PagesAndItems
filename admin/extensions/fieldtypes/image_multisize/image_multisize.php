...
class PagesAndItemsExtensionFieldtypeImage_multisize extends PagesAndItemsExtensionFieldtype
{
	...
	function display_item_edit($field, $field_params, $field_values, $field_value, $new_field, $field_id){
		...
		*/
		...
		//image size 1
		$html .= '<input type="hidden" name="'.$field_id.'_max_width_1" value="'.(isset($field_params['max_width_1']) ? $field_params['max_width_1'] : '').'" />';
		$html .= '<input type="hidden" name="'.$field_id.'_max_height_1" value="'.$field_params['max_height_1'].'" />';
		$html .= '<input type="hidden" name="'.$field_id.'_resize_1" value="'.(isset($field_params['resize_1']) ? $field_params['resize_1'] : '').'" />';
		...
		$html .= '<input type="hidden" name="'.$field_id.'_resize_2" value="'.(isset($field_params['resize_2']) ? $field_params['resize_2'] : '').'" />';
		...
		$html .= '<input type="hidden" name="'.$field_id.'_resize_3" value="'.(isset($field_params['resize_3']) ? $field_params['resize_3'] : '').'" />';
		...
		$html .= '<input type="hidden" name="'.$field_id.'_resize_4" value="'.(isset($field_params['resize_4']) ? $field_params['resize_4'] : '').'" />';
		...
		$html .= '<input type="hidden" name="'.$field_id.'_resize_5" value="'.(isset($field_params['resize_5']) ? $field_params['resize_5'] : '').'" />';
		...
		if($image_upload==true){
			...
			if (isset($_FILES[$image]['name'])){
				...
				if(!move_uploaded_file($userfile_tmp, $prod_img)){
					...
					return array('error'=>'Problem uploading image. File is too big. Try making the image smaller with an image-editor (like Photoshop or Gimp) and try again.');
				}
