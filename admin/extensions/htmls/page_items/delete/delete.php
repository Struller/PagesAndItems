...
class PagesAndItemsExtensionHtmlPage_itemsDelete extends PagesAndItemsExtensionHtml
{
	...
	function onGetHtmlelement(&$htmlelement,$name = null, $htmlOptions = null)
	{
		...
		$htmlelementVars->alt = JText::_('COM_PAGESANDITEMS_ITEMS_DELETE'); //JText::_('PI_EXTENSION_HTML_PAGE_ITEMS_DELETE_TIP');//.'(s)';
		
		//$htmlelementVars->onclick = 'javascript:Joomla.submitbutton(\'item.items_delete\')';
