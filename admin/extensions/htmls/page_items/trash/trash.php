...
class PagesAndItemsExtensionHtmlPage_itemsTrash extends PagesAndItemsExtensionHtml
{
	...
	function onGetHtmlelement(&$htmlelement,$name = null, $htmlOptions = null)
	{
		...
		//}
		$htmlelementVars->alt = JText::_('COM_PAGESANDITEMS_ITEMS_TRASH'); //JText::_('PI_EXTENSION_HTML_PAGE_ITEMS_TRASH_TIP');
		//$htmlelementVars->onclick = 'javascript:Joomla.submitbutton(\'item.items_trash\')';		
