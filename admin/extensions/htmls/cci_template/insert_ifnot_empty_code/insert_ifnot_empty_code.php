...
/**
*********************************
* Html insert_if_not_empty_code             *
********************************
*/
class PagesAndItemsExtensionHtmlCci_templateInsert_ifnot_empty_code extends PagesAndItemsExtensionHtml
{
...
//	function onGetHtmlelement(&$htmlelement,$name = null, $template = 'intro', $fields = array())
	function onGetHtmlelement(&$htmlelement,$name = null, $htmlOptions = null)
	{
		...
		$html = '';
		$html .= '<select name="pi_fields_if_not_empty_'.$template.'" onchange="insert_in_textarea( this.value , this.form.pi_fields_if_not_empty_'.$template.'.options[this.form.pi_fields_if_not_empty_'.$template.'.selectedIndex].label,\'template_'.$template.'\' );this.options[0].selected=true;return false;">';
		$html .= '<option value="" selected="selected">- '.JText::_('COM_PAGESANDITEMS_INSERT_IF_NOT_EMPTY_CODE').' - </option>';
