...
********************************
*/
class PagesAndItemsExtensionHtmlCategory_actionsTrash extends PagesAndItemsExtensionHtml
{
	...
	function onGetHtmlelement(&$htmlelement,$name = null, $htmlOptions = null)
	{
		...
		$htmlelementVars->onclick = 'javascript:if (document.adminForm.boxcheckedCategory.value==0){alert(\''.JText::_('JLIB_HTML_PLEASE_MAKE_A_SELECTION_FROM_THE_LIST').'\');}else{ PagesAndItemsCategories.submitbutton(\'category.categories_trash\')}';
