...
*/
		...
		parent::display($tpl);
		$this->addToolbar();
		//add here to override pagesanditems.css
	...
	{
		JToolBarHelper::custom('piextensions.publish', 'publish.png', 'publish_f2.png', 'COM_PAGESANDITEMS_ENABLE', true);
		JToolBarHelper::custom('piextensions.unpublish', 'unpublish.png', 'unpublish_f2.png', 'COM_PAGESANDITEMS_DISABLE', true);
		JToolBarHelper::divider();
		JToolBarHelper::deleteList('', 'piextensions.remove','COM_PAGESANDITEMS_UNINSTALL');
